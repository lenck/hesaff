...
FLAGS := -O3 -Wall -lrt -I$(OPENCV_INC_PATH) -I$(OPENCV_INC_PATH)/opencv -L$(OPENCV_LIB_PATH)  -Wl,-rpath=$(OPENCV_LIB_PATH) -lopencv_highgui -lopencv_imgcodecs -lopencv_photo -lopencv_imgproc -lopencv_core
